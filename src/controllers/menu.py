...
from src.controllers.forms.forms import MenuForm
...
def create_menu_view():
    ...
    if request.method == 'POST' and form.validate():
        # gets inputs
        date = form.date.data
        n_days_ago = form.n_days_ago.data
        min_calories = form.min_calories.data
        max_calories = form.max_calories.data
        min_fats = form.min_fats.data
        max_fats = form.max_fats.data
        min_proteins = form.min_proteins.data
        max_proteins = form.max_proteins.data
        min_carbohydrates = form.min_carbohydrates.data
        max_carbohydrates = form.max_carbohydrates.data

        flash('Menu has been created!', 'success')
        return redirect(url_for('menu.history', date=date))

    return render_template('menu/create-menu.html', form=form, today=d.today())
